...
+  Go to the settings page of your repository at Github and and fill in
   ...
   Step 1
      .. figure:: GithubKnowHowImages/001-settings.png
         :class: screenshot-detail

   Step 2
      .. figure:: GithubKnowHowImages/002-service-hooks.png
         :class: screenshot-detail

   Step 3
      .. figure:: GithubKnowHowImages/003-webhook-url.png
         :class: screenshot-detail

   Step 4
      .. figure:: GithubKnowHowImages/004-enter-the-url.png
         :class: screenshot-detail
